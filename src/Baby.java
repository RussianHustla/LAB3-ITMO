public class Baby extends Human {
    ...
    void move(Place place) {
        System.out.println(getName() + " ползет на локацию " + place.getName());
        this.place = place;
    }
    ...
    public Baby(String name, int age, Gender gender, Place place) {
        ...
        this.place = place;
        this.noOfObjects++;
        System.out.println("Создан ребенок по имени " + name + " с возрастом " + age + " гендера " + gender + " находящийся в месте " + place.getName());
    }
